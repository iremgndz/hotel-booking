...
import TitlebarImageList1 from './TitlebarImageList/TitlebarImageList1'
...
export default function TravelPlan() {
 ...
 return (
     ...
     <div className='headerSearchItem'>
       ...
       {openOption && <div className='options'>
           <div className='optionItem'>
             ...
             <button
              disabled={options.adult <= 1} // 1 yetişkinden az olamaz
    ...
    <div>
    <TitlebarImageList1></TitlebarImageList1>
